...
import {
  ...
  // Research high-risk operation authorization (GC-RSCH-R005 / ADR-084)
...
describe("MCP–OpenAPI write-contract", () => {
  ...
  // -------------------------------------------------------------------------
  // gc_research_operation_authorization — request (GC-RSCH-R005 / ADR-084 §3)
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // gc_research_operation_authorization — decide (GC-RSCH-R005 / ADR-084 §3)
  // -------------------------------------------------------------------------
