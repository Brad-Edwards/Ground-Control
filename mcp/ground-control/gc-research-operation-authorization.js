...
// GC-RSCH-N005 / GC-RSCH-N006, ADR-086). Run-scoped, default-deny authorization
...
export const GC_RESEARCH_OPERATION_AUTHORIZATION_REQUEST_REQUIRED_FIELDS = [
  ...
  "destination_class",
  "requested_form",
  // ADR-086 §1: an authorization must bind a concrete effect request.
  "tool_id",
  "sandbox_profile",
  "summary",
  "source_action_id",
...
export const GC_RESEARCH_OPERATION_AUTHORIZATION_DESCRIPTION =
  `Research high-risk operation authorization (GC-RSCH-R005 / ADR-086). Run-scoped, default-deny ` +
