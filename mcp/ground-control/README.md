...
- **Allowlist (canonical source: `GC_QUERY_PATH_ALLOWLIST` in
  ...
  `/api/v1/audits`, `/api/v1/backlog-items`, `/api/v1/baselines`, `/api/v1/control-effectiveness-assessments`,
  `/api/v1/control-tests`, `/api/v1/controls`, `/api/v1/dashboard`, `/api/v1/decisions`,
