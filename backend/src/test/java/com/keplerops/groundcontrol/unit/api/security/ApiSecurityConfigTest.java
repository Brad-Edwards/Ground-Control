...
class ApiSecurityConfigTest {
    ...
    static class StubController {
        ...
        // Research high-risk operation authorization (issue #1008 / ADR-084): the decision and
    ...
    class WithSecurityEnabled {
        ...
        void userTokenOnResearchOpAuthDecision_returns403() throws Exception {
            // ADR-084 §3: an AUTONOMOUS run (or ordinary member) cannot approve a high-risk operation.
        ...
        void userTokenOnResearchOpAuthConsume_returns403() throws Exception {
            // ADR-084 §3: spending a one-time-use approval is the trusted executor/operator boundary.
