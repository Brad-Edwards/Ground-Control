    ...
    void migrationVerification() throws Exception {
        ...
        assertThat(versions)
                .containsExactly(
                        ...
                        "188", // V188: research_run operation policy snapshot (#1008, ADR-085)
                        "189", // V189: research_run policy snapshot audit (#1008 audit parity)
                        "190", // V190: research_intake egress policy (#1008, ADR-085)
                        "191", // V191: research_intake egress policy audit (#1008 audit parity)
                        "192", // V192: research_run_artifact data class (#1008, ADR-085)
                        "193", // V193: research_run_artifact data class audit (#1008 audit parity)
                        "194", // V194: create research_run_operation_authorization (#1008, ADR-085)
