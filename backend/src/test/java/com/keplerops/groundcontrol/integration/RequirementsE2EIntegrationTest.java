    ...
    void migrationVerification() throws Exception {
        ...
        assertThat(versions)
                .containsExactly(
                        ...
                        "171", // V171: create evidence_campaign aggregate (GC-S005)
                        "172", // V172: create evidence_campaign_audit shadow (GC-S005 audit parity)
                        "173"); // V173: create evidence_campaign_run telemetry (GC-S005)
    }
}
