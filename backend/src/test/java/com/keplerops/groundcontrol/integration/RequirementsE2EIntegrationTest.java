    ...
    void migrationVerification() throws Exception {
        ...
        assertThat(versions)
                .containsExactly(
                        ...
                        "169", // V169: create evidence_campaign aggregate (GC-S005)
                        "170", // V170: create evidence_campaign_audit shadow (GC-S005 audit parity)
                        "171"); // V171: create evidence_campaign_run telemetry (GC-S005)
    }
}
