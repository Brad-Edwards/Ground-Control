...
- **High-risk effects:** generated code execution, browser activity,
  lab/hardware actions, and external writes under ADR-084.
...
- ADR-084 is the binding decision for prompt-injection handling, structured
...
- **High-risk authorization:** ADR-084 operation authorization is required
...
- No replacement of ADR-055 citation MCP, ADR-064 lifecycle, ADR-069 provenance,
  ...
  or ADR-084 high-risk operation authorization.
