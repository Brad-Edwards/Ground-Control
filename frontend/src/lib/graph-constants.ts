...
export const ENTITY_TYPE_COLORS: Record<string, string> = {
  ...
  CONTROL_LINK: "#15803d",
  CONTROL_TEST: "#84cc16",
  CONTROL_EFFECTIVENESS_ASSESSMENT: "#65a30d",
  VERIFICATION_RESULT: "#06b6d4",
  THREAT_MODEL: "#dc2626",
  FINDING: "#ec4899",
  ARCHITECTURE_MODEL_ELEMENT: "#2563eb",
  AUDIT: "#8b5cf6",
  AUDIT_LINK: "#7c3aed",
  RISK_CONTROL_MAPPING: "#f59e0b",
  SCOPED_CONTROL_IMPLEMENTATION: "#0891b2",
  RISK_APPETITE_PROFILE: "#b45309",
  DOCUMENT: "#64748b",
  RESEARCH_RUN: "#4f46e5",
  RESEARCH_ARTIFACT: "#0d9488",
  RESEARCH_PROVENANCE_NODE: "#7e22ce",
};
