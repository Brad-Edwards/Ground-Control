...
and `getTraceabilityMatrix`, `getControlWorkspace`, `getEvidenceExplorer`, and
`analyzePortfolio` for GC-Q003/Q011/Q012/Q013) that directly mirror backend
...
a new style rule is being established.
